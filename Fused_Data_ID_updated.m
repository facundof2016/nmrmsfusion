%% Fused_Data_NoClean cut -- Taken without PLSDA on the individual methods, and the in group separation was not corrected the first 0.75 adn 0.65 minutes
%removed from the HILIC and RP respectively
...
Fused_Data.Fused_Data.All_Intensity=[Fused_Data.HILIC_POS.Intensity...
    Fused_Data.HILIC_NEG.Intensity Fused_Data.NMR.Intensity];
Fused_Data.Fused_Data.All_Points=[Fused_Data.HILIC_POS.MRT(1,:) Fused_Data.HILIC_NEG.MRT(1,:)...
    ...
    Fused_Data.HILIC_NEG.MRT(2,:) Fused_Data.NMR.ppm];
...
Fused_Data.Fused_Data_sum.All_Intensity=[Fused_Data.HILIC_POS.Intensity...
    Fused_Data.HILIC_NEG.Intensity Fused_Data.NMR_sum.Intensity];
Fused_Data.Fused_Data_sum.All_Points=[Fused_Data.HILIC_POS.MRT(1,:) Fused_Data.HILIC_NEG.MRT(1,:)...
    ...
    Fused_Data.HILIC_NEG.MRT(2,:) Fused_Data.NMR_sum.ppm];
...
[Fused_Data.Fused_Data_sum.RHO,Fused_Data.Fused_Data_sum.PVAL]=corr(Fused_Data.Fused_Data_sum.All_Intensity);
